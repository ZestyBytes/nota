...
// --- One-time migration: existing attachments -> R2 --------------------
// Visit GET /admin/migrate-media once, signed in, to run this. Safe to
// re-run: an R2 object already present is skipped (checked with head, not
// a metered read), and a markdown file whose old reference is already
// gone is left alone. Remove this block (and the route below) once the
// migration is confirmed done; it's a one-off, not a lasting feature.
const MIGRATION_FILES = [
  "IMG_4035.jpeg", "IMG_4045.jpeg", "IMG_4051.jpeg",
  "oving-cow-shed-machine.jpg", "oving-cow-shed-bench.jpg",
  "IMG_5395.jpeg", "IMG_5437.jpeg", "IMG_5496.jpeg", "IMG_5405.jpeg",
  "IMG_5839.jpeg", "IMG_5936.jpeg",
  "1211ad66-adbe-4911-9a01-c7cf3d63f2cd.jpeg",
  "octopus-charger.png", "garden-birthday-party.png", "banana-bread.jpg",
  "plant-asparagus-fern.jpg", "plant-devils-ivy.jpg", "plant-dragon-tree.jpg",
  "plant-parlour-palm.jpg", "plant-peace-lily.jpg", "plant-philodendron-birkin.jpg",
  "plant-spider-plant.jpg",
  "2026-09-11-dog-1.jpg", "2026-09-11-dog-2.jpg", "2026-09-11-dog-3.jpg",
  "2026-09-11-dog-4.jpg", "2026-09-11-dog-5.jpg",
];

const MIGRATION_REPLACEMENTS = [
  { path: "quartz/content/journal/what-i-want-from-the-garden.md", replacements: [
    ["![[IMG_4035.jpeg]]", "![](/media/attachments/IMG_4035.jpeg)"],
    ["![[IMG_4045.jpeg]]", "![](/media/attachments/IMG_4045.jpeg)"],
    ["![[IMG_4051.jpeg]]", "![](/media/attachments/IMG_4051.jpeg)"],
  ] },
  { path: "quartz/content/journal/the-oving-cow-shed.md", replacements: [
    ["![[oving-cow-shed-machine.jpg]]", "![](/media/attachments/oving-cow-shed-machine.jpg)"],
    ["![[oving-cow-shed-bench.jpg]]", "![](/media/attachments/oving-cow-shed-bench.jpg)"],
  ] },
  { path: "quartz/content/journal/barcelona.md", replacements: [
    ["![[IMG_5395.jpeg]]", "![](/media/attachments/IMG_5395.jpeg)"],
    ["![[IMG_5437.jpeg]]", "![](/media/attachments/IMG_5437.jpeg)"],
    ["![[IMG_5496.jpeg]]", "![](/media/attachments/IMG_5496.jpeg)"],
    ["![[IMG_5405.jpeg]]", "![](/media/attachments/IMG_5405.jpeg)"],
  ] },
  { path: "quartz/content/journal/school-starts.md", replacements: [
    ["![[IMG_5839.jpeg]]", "![](/media/attachments/IMG_5839.jpeg)"],
  ] },
  { path: "quartz/content/journal/the-claw-machine.md", replacements: [
    ["![[IMG_5936.jpeg]]", "![](/media/attachments/IMG_5936.jpeg)"],
  ] },
  { path: "quartz/content/journal/wisdom-tooth-day-eight.md", replacements: [
    ["![[1211ad66-adbe-4911-9a01-c7cf3d63f2cd.jpeg]]", "![](/media/attachments/1211ad66-adbe-4911-9a01-c7cf3d63f2cd.jpeg)"],
  ] },
  { path: "quartz/content/events/octopus-ev-installation.md", replacements: [
    ["![[octopus-charger.png|The Octopus tethered charger and its cable]]", "![The Octopus tethered charger and its cable](/media/attachments/octopus-charger.png)"],
  ] },
  { path: "quartz/content/events/garden-birthday-party.md", replacements: [
    ["![[garden-birthday-party.png|Jamie's garden birthday party poster]]", "![Jamie's garden birthday party poster](/media/attachments/garden-birthday-party.png)"],
  ] },
  { path: "quartz/content/recipes/banana-bread.md", replacements: [
    ["](attachments/banana-bread.jpg)", "](/media/attachments/banana-bread.jpg)"],
  ] },
  { path: "quartz/content/plants/asparagus-fern.md", replacements: [
    ["(plant-asparagus-fern.jpg)", "(/media/attachments/plant-asparagus-fern.jpg)"],
  ] },
  { path: "quartz/content/plants/devils-ivy.md", replacements: [
    ["(plant-devils-ivy.jpg)", "(/media/attachments/plant-devils-ivy.jpg)"],
  ] },
  { path: "quartz/content/plants/dragon-tree.md", replacements: [
    ["(plant-dragon-tree.jpg)", "(/media/attachments/plant-dragon-tree.jpg)"],
  ] },
  { path: "quartz/content/plants/parlour-palm.md", replacements: [
    ["(plant-parlour-palm.jpg)", "(/media/attachments/plant-parlour-palm.jpg)"],
  ] },
  { path: "quartz/content/plants/peace-lily.md", replacements: [
    ["(plant-peace-lily.jpg)", "(/media/attachments/plant-peace-lily.jpg)"],
  ] },
  { path: "quartz/content/plants/philodendron-birkin.md", replacements: [
    ["(plant-philodendron-birkin.jpg)", "(/media/attachments/plant-philodendron-birkin.jpg)"],
  ] },
  { path: "quartz/content/plants/spider-plant.md", replacements: [
    ["(plant-spider-plant.jpg)", "(/media/attachments/plant-spider-plant.jpg)"],
  ] },
  { path: "quartz/content/plants/the-office-light.md", replacements: [
    ["![[plant-peace-lily.jpg]]", "![](/media/attachments/plant-peace-lily.jpg)"],
  ] },
  { path: "quartz/content/journal/2026-09-11-before-i-turn-35.md", replacements: [
    ["(2026-09-11-dog-1.jpg)", "(/media/attachments/2026-09-11-dog-1.jpg)"],
    ["(2026-09-11-dog-2.jpg)", "(/media/attachments/2026-09-11-dog-2.jpg)"],
    ["(2026-09-11-dog-3.jpg)", "(/media/attachments/2026-09-11-dog-3.jpg)"],
    ["(2026-09-11-dog-4.jpg)", "(/media/attachments/2026-09-11-dog-4.jpg)"],
    ["(2026-09-11-dog-5.jpg)", "(/media/attachments/2026-09-11-dog-5.jpg)"],
  ] },
];
...
async function migrateMedia(env) {
  ...
  for (const name of MIGRATION_FILES) {
    ...
    try {
      ...
      if (bytes.byteLength > MEDIA_MAX_UPLOAD_BYTES) {
        report.failed.push({ name, error: `too large (${(bytes.byteLength / 1024 / 1024).toFixed(1)}MB), resize it first` });
        continue;
      }
      if (!(await reserveStorage(env, bytes.byteLength))) {
        report.failed.push({ name, error: "storage budget reached" });
        continue;
      }
      if (!(await reserveClassA(env, 1))) {
        report.failed.push({ name, error: "R2 write budget reached for this month" });
        continue;
      }
  ...
  for (const { path, replacements } of MIGRATION_REPLACEMENTS) {
    try {
      ...
      await githubRequest(env, `/repos/${GITHUB_OWNER}/${GITHUB_REPO}/contents/${path}`, {
        method: "PUT",
        body: JSON.stringify({
          message: `Point ${path} at R2 media`,
          content: utf8ToB64(raw),
          sha: file.sha,
          branch: GITHUB_BRANCH,
        }),
      });
      report.filesUpdated.push(path);
    } catch (err) {
      report.fileErrors.push({ path, error: String(err.message || err) });
    }
  }
...
export default {
  async fetch(request, env) {
    ...
    if (cookieToken === expectedToken) {
      ...
      // One-off: visit this once, signed in, to move the existing
      // attachments into R2 and repoint the markdown that references
      // them. Safe to visit more than once, see migrateMedia's comment.
      if (request.method === "GET" && url.pathname === "/admin/migrate-media") {
        if (!env.GITHUB_TOKEN) return Response.json({ error: "GITHUB_TOKEN not configured" }, { status: 500 });
        const report = await migrateMedia(env);

...
const SHELL=["./","index.html","styles.css?v=native-demos-1","shelf-fix.css?v=9","config.js","backend.js","app.js?v=shelf-loopfix-1","data.js","manifest.webmanifest","icon.svg"];

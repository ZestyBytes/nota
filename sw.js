...
const SHELL=["./","index.html","styles.css?v=home-tasks-2col","shelf-fix.css?v=11","config.js","backend.js","app.js?v=home-tasks-2col","data.js","manifest.webmanifest","icon.svg"];

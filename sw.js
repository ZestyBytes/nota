...
const SHELL=["./","index.html","styles.css?v=claw-game-1","shelf-fix.css?v=5","config.js","backend.js","app.js?v=collected-shelf-1","data.js","manifest.webmanifest","icon.svg"];

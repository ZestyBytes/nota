...
const SHELL=["./","index.html","styles.css?v=no-image-title-1","shelf-fix.css?v=10","config.js","backend.js","app.js?v=shelf-hand-1","data.js","manifest.webmanifest","icon.svg"];

...
const SHELL=["./","index.html","styles.css?v=home-modules-1","shelf-fix.css?v=11","config.js","backend.js","app.js?v=home-modules-1","data.js","manifest.webmanifest","icon.svg"];

...
- `--stamp-green: #3f6b2e` — published stamp
...
- **Stamp**: `PRIVATE`/`PUBLISHED` rendered as a rotated bordered rubber-stamp mark (`.stamp`), never a soft color fade — a hard state change.
